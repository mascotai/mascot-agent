import { pgTable, uuid, text, timestamp, jsonb, boolean, index, unique, pgEnum } from 'drizzle-orm/pg-core';
...
export const serviceCredentialsTable = pgTable('plugin_service_credentials', {
  ...
  unique('plugin_service_credentials_agent_service_unique')
    .on(table.agentId, table.serviceName),
]);
